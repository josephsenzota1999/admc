...
if(isset($_POST['submit'])){
    ...
    $query = mysqli_query($conn, "SELECT * FROM events where title = '$name'");
    $rows =mysqli_fetch_assoc($query);
    if ($rows['title'] == $title) {
        array_push($errors, 'Annoucements already exist!');
    }else{
        $query = mysqli_query($conn, "INSERT INTO events(title,dates)values('$title','$desc')");
        if ($query) {
...
<i class="fa-solid fa-plus"></i>  Create Events
</button>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <input type="text" class="form-control" name='title' id="exampleFormControlInput1" placeholder="Event">
</div>
<div class="mb-3">
...
<table id="example" class="table table-striped dt-responsive nowrap" style="width:100%">
      ...
      <td><?php echo $rows['title'] ?></td>
          ...
          <td>
            <a href='deleteEvent.php?id=<?php echo $rows['id'] ?>' class='btn btn-danger'> <i class="fa-solid fa-trash"></i></a>
          </td>
      </tr>
