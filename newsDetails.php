...
<nav style='padding-left:30px;padding-right:30px;' class="navbar navbar-expand-lg jana">
  ...
  <div class='container mt-5 ml-3'>
        <div class='row justify-content-center'>
            ...
            <?php
                $id = $_GET['id'];
                $query = "select id,image,description,title,cast(created AS date),cast(created AS Time) from news WHERE id='$id'";
                ...
                <div class='card mt-4'>
                    <div class='imgs'>
                    <img src="./images/<?php echo $data['image']; ?>" width='400em' height='400em'>
                </div>
                <div class='contes'>
        ...
        <div class='echos'>
          <i>      <p><span><i class="fa-solid fa-calendar" ></i> <?php echo $data['cast(created AS date)'] ?></span>  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
            ...
            <div class='description'>
              ...
              <i>      <p><span><i class="fa-solid fa-calendar" ></i> <?php echo $data['description'] ?>
              </p>
            </div>
        </div>
