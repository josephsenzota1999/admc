            ...
            while ($rows =  mysqli_fetch_assoc($query)) {
              ?>
                ...
                <tr>
                 ...
                 <td>
                 <a class='btn btn-primary' href='changeApp.php?id=<?php echo $rows['id'] ?>'>Approve <i class="fa-solid fa-thumbs-up"></i></a>
                  <a class='btn btn-primary' href='moreApp.php?id=<?php echo $rows['id'] ?>'>More <i class="fa-solid fa-arrow-right"></i></a>
                  <a class='btn btn-danger' href='deleteApp.php?id=<?php echo $rows['id'] ?>'><i class="fa-solid fa-trash"></i></a>
