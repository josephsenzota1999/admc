...
<div class='banners'>
  ...
  <div class='container alaa mb-5'>
    ...
    <div class='row justify-content-center'>
       <h5 class='mb-4' style='color:#1061f0; font-weight:700;position:relative;left:35px;'>Annoucements</h5>
    ...
    <table id="example" class="table table-striped dt-responsive nowrap" style="width:100%">
        ...
        <tbody>
          <?php
          $query = mysqli_query($conn, 'SELECT title,desci,cast(file AS Date) FROM anno');
      ...
      <tr>
          ...
          <td><?php echo $rows['cast(file AS Date)'] ?></td>
            <td>               
                 <a href="uploads/<?php echo $rows['title']; ?>" download>  <p class='btn btn-primary' 
                 >Download</p></a>
</td>
      </tr>
      ...
      <div class='titles1'>
              ...
              <div class='cirlce' style='border:1px solid #1061f0;border-radius:50%;width:26%;height: 60px;
  ...
  <span style='position:relative;left:19px'>
              ...
              <span style='font-size:14px;position:relative;left:16px'>
                    <?php 
...
&nbsp; &nbsp;
              <div>
              <span style='font-size:15px;position:relative;top:13px'><?php echo $rows['title'] ?></span>
              ...
              <?php
                ...
                ?>
<center>
  <a href='userEvents.php'><p class='mr'>More Events <i class="fa-solid fa-arrow-right"></i></p></a>
</center>
<?php
              }else{
                ?>
