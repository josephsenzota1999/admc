...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO news (image,title,description) VALUES ('$filename','$title','$desc')";
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <input type="text" class="form-control" name='title' id="exampleFormControlInput1" placeholder="Title">
        ...
        <div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">News</label>
  <input type="file" class="form-control" name='uploadfile' id="exampleFormControlInput1" placeholder="News Image/Video">
</div>
<div class="mb-3">
...
<table id="example" class="table table-striped dt-responsive nowrap" style="width:100%">
      ...
      <td><?php echo $rows['image'] ?></td>
          ...
          <td>
          <a href='moreNews.php?id=<?php echo $rows['id'] ?>' class='btn btn-primary'>More  <i class="fa-solid fa-arrow-right"></i></a>
            <a href='deleteNews.php?id=<?php echo $rows['id'] ?>' class='btn btn-danger'> <i class="fa-solid fa-trash"></i></a>
